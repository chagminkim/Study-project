...
import study.mymemo.repository.MemoCategoryRepository;
...
public class MemoService {
    ...
    public MemoService(MemoRepository memoRepository, CategoryRepository categoryRepository, MemoCategoryRepository memoCategoryRepository) {
        this.memoRepository = memoRepository;
        this.categoryRepository = categoryRepository;
        this.memoCategoryRepository = memoCategoryRepository;
    }

    public MemoResponse save(MemoCreateRequest request) {
    ...
    public MemoResponse update(Long memoId, MemoUpdateRequest request) {
